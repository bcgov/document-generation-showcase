...
const MODULE_NAME = 'cdogs-service-secret';
    ...
    const prompts = [
      {
        type: 'input',
        name: 'objectName',
        message: 'Enter the name for the CDOGS keycloak secret',
        default: this.answers.objectName || MODULE_NAME
      },
      {
        type: 'input',
        name: 'clientId',
        message: 'Enter the CDOGS keycloak client id',
        default: this.answers.clientId || 'DGRSC_SERVICE_CLIENT'
      },
      {
        type: 'password',
        mask: '*',
        name: 'clientSecret',
        message: 'Enter the CDOGS keycloak client secret',
